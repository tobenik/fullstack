...
describe('handling bad usernames and passwords', () => {
...
describe('login works correctly', () => {
  ...
  test('can login with correct credentials', async () => {
    const user = { username: "stevieboi", password: "apple123" }
    const result = await api
      .post('/api/login')
      .send(user)
      .expect(200)
  ...
  test('login with incorrect credentials denied', async () => {
    const user = { username: "stevieboi", password: "nokia123" }
    const result = await api
      .post('/api/login')
      .send(user)
      .expect(401)
